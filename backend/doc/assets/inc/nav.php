    ...
    <div class="navbar-custom">
        ...
        <div class="logo-box">
            <a href="his_doc_dashboard.php" class="logo text-center">
                <span class="logo-lg">
                    <img src="assets/images/abc.png" alt="" height="18">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="his_doc_patient_lab_test.php" class="dropdown-item">
                        <i class="fe-hard-drive mr-1"></i>
                        <span>Lab Tests</span>
                    </a>
                    <!-- item-->
                    <a href="his_doc_patient_lab_result.php" class="dropdown-item">
                        <i class="fe-hard-drive mr-1"></i>
