                                ...
                                <div class="card-box">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="float-right">
                                            <h4 class="m-0 d-print-none"><?php echo $row->pay_doc_name; ?> Salary</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 offset-md-2">
                                            <div class="mt-3 float-right">
                                                ...
                                                <p class="m-b-10"><strong>Doctor Number. : </strong> <span class="float-right"><?php echo $row->pay_doc_number; ?></span></p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="float-right">
                                                ...
                                                <p><b>PAYE Tax (13%) :</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; <?php echo $taxable_salary; ?> </span></p>
