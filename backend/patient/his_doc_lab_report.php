...
$pat_number = $_SESSION['pat_number']; // Retrieve patient's number from session
?>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                            /*
                                                *get details of the logged-in patient
                                                *
                                            */
                                                $ret="SELECT * FROM  his_laboratory WHERE lab_pat_number=?"; 
                                                //sql code to get details of the logged-in patient
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo date("d/m/Y \#\ H:i:s", strtotime($mysqlDateTime));?></td>
