...
if (isset($_POST['update_profile'])) {
    ...
    $stmt->bind_param('ssssi', $pat_fname, $pat_lname, $pat_email, $pat_dpic, $pat_id);
    $stmt->execute();
...
if (isset($_POST['update_pwd'])) {
    ...
    $query = "SELECT pat_pwd FROM his_patients WHERE pat_number=?";
    $stmt = $mysqli->prepare($query);
    ...
    if ($db_old_pwd === $old_pwd) {
        if ($new_pwd === $confirm_password) {
            ...
            $stmt = $mysqli->prepare($query);
            $stmt->bind_param('ss', $new_pwd, $pat_number);
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    <img src="../patient/assets/images/users/<?php echo $row->pat_dpic; ?>" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">


                                    <div class="text-centre mt-3">

                                        <p class="text-muted mb-2 font-13"><strong>Patient Full Name :</strong> <span class="ml-2"><?php echo $row->pat_fname; ?> <?php echo $row->pat_lname; ?></span></p>
                                        
                                        <p class="text-muted mb-2 font-13"><strong>Patient Number :</strong> <span class="ml-2"><?php echo $row->pat_number; ?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Patient Email :</strong> <span class="ml-2"><?php echo $row->pat_email; ?></span></p>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="pat_fname" class="form-control" id="firstname" value="<?php echo $row->pat_fname; ?>" placeholder="Enter your First name.">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="lastname">Last Name</label>
                                                            <input type="text" name="pat_lname" class="form-control" id="lastname" value="<?php echo $row->pat_lname; ?>" placeholder="Enter your last name.">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="pat_email" class="form-control" id="useremail" value="<?php echo $row->pat_email; ?>" placeholder="Enter your email address.">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
