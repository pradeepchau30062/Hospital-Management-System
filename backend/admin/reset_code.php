...
function send_password_reset($get_name, $get_email)
{
    ...
    try {
        ...
        <br></br>
        <a href='https://localhost/Hospital-PHP/backend/admin/password_update.php?ad_email=$get_email'>Click here to reset your password.</a>
...
if (isset($_POST['password_reset_link'])) {
    ...
    $ad_email = mysqli_real_escape_string($mysqli, $_POST['ad_email']);

    $check_email = "SELECT ad_fname, ad_email FROM his_admin WHERE ad_email = '$ad_email' LIMIT 1";
    ...
    if (mysqli_num_rows($check_email_run) > 0) {
        ...
        $get_name = $row['ad_fname'];
        $get_email = $row['ad_email'];
