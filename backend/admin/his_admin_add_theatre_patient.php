                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                            $ret = "SELECT * FROM his_patients WHERE pat_type = 'InPatient' AND (pat_discharge_status IS NULL OR pat_discharge_status = 'Re-Admit') AND (surgery_status IS NULL OR surgery_status != 'Admit') ORDER BY RAND()";
