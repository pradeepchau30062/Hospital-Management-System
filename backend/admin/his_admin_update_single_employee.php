<?php
    ...
    if (isset($_POST['update_doc'])) {
        ...
        $doc_id = $_POST['doc_id'];  // Ensure you are getting the doc_id from the form
        ...
        $stmt->bind_param('sssssi', $doc_fname, $doc_lname, $doc_email, $doc_pwd, $doc_dpic, $doc_id);

        // Check if the execution was successful
        if ($stmt->execute()) {
            $success = "Doctors Details Updated";
        } else {
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="update_doc" class="ladda-button btn btn-success" data-style="expand-right">Update Doctors</button>
                                    </form>
                                    <!--End Patient Form-->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
