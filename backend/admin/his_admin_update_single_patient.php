                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="number" value="<?php echo $row->pat_age; ?>" name="pat_age" class="form-control" id="age_v" placeholder="Patient's Age" min="1">
                                                    <script type="text/javascript">
                                                        function validateAge() {
                                                            var ageInput = document.getElementById("age_v");
                                                            ageInput.addEventListener("input", function() {
                                                                var value = parseFloat(this.value);
                                                                if (isNaN(value) || value <= 0) {
                                                                    this.setCustomValidity("Please enter a positive Age.");
                                                                } else {
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->pat_phone; ?>" name="pat_phone" class="form-control" id="number_v">
                                                    <script type="text/javascript">
                                            ...
                                            <button type="submit" name="update_patient" class="ladda-button btn btn-success" data-style="expand-right">Update Patient Details </button>
